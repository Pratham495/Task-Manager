...
const Attachments = (link, index, onClick) => {
  return <div className="flex justify-between bg-gray-50 border border-gray-100 
  px-3 py-2 rounded-md mb-3 mt-2 cursor-pointer">
    <div className="flex-1 flex items-center gap-3">
      <span className="text-xs text-gray-100 font-semibold mr-2 ">
